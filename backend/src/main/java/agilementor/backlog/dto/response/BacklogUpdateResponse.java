...
public record BacklogUpdateResponse(
    Long backlogId,
    Long projectId,
    Long sprintId,
    Long storyId,
    ...
    public static BacklogUpdateResponse from(Backlog backlog) {
        ...
        return new BacklogUpdateResponse(backlogId, projectId, sprintId, storyId, memberId,
