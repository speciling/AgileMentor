...
public record BacklogCreateResponse(
    Long backlogId,
    Long projectId,
    Long sprintId,
    Long storyId,
    ...
    public static BacklogCreateResponse from(Backlog backlog) {
        ...
        return new BacklogCreateResponse(backlogId, projectId, sprintId, storyId, memberId,
